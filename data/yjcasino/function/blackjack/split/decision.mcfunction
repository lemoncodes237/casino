...
$execute if score @s yj-blackjack-split$(split)-cards matches 2 if entity @s[tag=yj-das] run scoreboard players set $yj-can-double yj-casino-temp 1
...
$execute if score @s yj-last-card = $yj-first-card yj-casino-temp if score @s yj-blackjack-split$(split)-cards matches 2 if score @s yj-blackjack-splits matches 1..2 run scoreboard players set $yj-can-split yj-casino-temp 1
...
$execute if score @s yj-last-card = $yj-first-card yj-casino-temp if score @s yj-blackjack-split$(split)-cards matches 2 if entity @s[tag=yj-blackjack-ace] as @a if score @s yj-id = $yj-temp yj-id run return run function yjcasino:blackjack/decision_dialog/split_stand with storage yjcasino:blackjack
