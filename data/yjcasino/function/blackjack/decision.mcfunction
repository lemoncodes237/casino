...
execute if score @s yj-cards matches 2 run scoreboard players set $yj-can-double yj-casino-temp 1
...
execute if score @s yj-last-card = $yj-first-card yj-casino-temp if score @s yj-cards matches 2 run scoreboard players set $yj-can-split yj-casino-temp 1
