...
execute at @s run summon text_display ^ ^0.15 ^1 {Tags:["yj-insurance-display"]}
execute store result storage yjcasino:bet bet double 0.01 run scoreboard players get $yj-arg2 yj-casino-var
execute at @s positioned ^ ^0.15 ^1 run function yjcasino:blackjack/show_insurance_bet with storage yjcasino:bet
