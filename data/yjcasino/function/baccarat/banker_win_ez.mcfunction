# If 3 card 7, then it's actually a push
execute if score $yj-temp yj-cards-banker matches 3 if score $yj-temp yj-total-banker matches 7 run return run function yjcasino:baccarat/push
