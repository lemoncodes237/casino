...
execute if entity @e[type=interaction,tag=yj-baccarat-no,tag=yj-bet-spot,distance=..1] run data modify storage yjcasino:bet commission set value "No Commission (Banker bet pays 1-to-2 on wins with total of 6)"
