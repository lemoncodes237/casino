...
execute at @s positioned ^ ^ ^2 as @e[type=villager,tag=yj-dealer,distance=..2,sort=nearest,limit=1] run tag @s add yj-dealer-temp
...
execute at @s positioned ^ ^ ^2 as @e[type=villager,tag=yj-dealer,distance=..2,sort=nearest,limit=1] run scoreboard players operation $yj-temp yj-game-id = @s yj-game-id
