...
execute positioned ^4 ^1 ^1 facing ^8 ^ ^2 as @e[type=interaction,tag=yj-bet-spot-bet,tag=yj-bet-spot-in-play,limit=1,sort=nearest,distance=..1] if score @s yj-stage matches 0 positioned ^ ^0.01 ^-0.5 run return run function yjcasino:war/deal_card
execute positioned ^3 ^1 ^3 facing ^6 ^ ^6 as @e[type=interaction,tag=yj-bet-spot-bet,tag=yj-bet-spot-in-play,limit=1,sort=nearest,distance=..1] if score @s yj-stage matches 0 positioned ^ ^0.01 ^-0.5 run return run function yjcasino:war/deal_card
execute positioned ^0 ^1 ^4 facing ^0 ^ ^8 as @e[type=interaction,tag=yj-bet-spot-bet,tag=yj-bet-spot-in-play,limit=1,sort=nearest,distance=..1] if score @s yj-stage matches 0 positioned ^ ^0.01 ^-0.5 run return run function yjcasino:war/deal_card
execute positioned ^-3 ^1 ^3 facing ^-6 ^ ^6 as @e[type=interaction,tag=yj-bet-spot-bet,tag=yj-bet-spot-in-play,limit=1,sort=nearest,distance=..1] if score @s yj-stage matches 0 positioned ^ ^0.01 ^-0.5 run return run function yjcasino:war/deal_card
execute positioned ^-4 ^1 ^1 facing ^-8 ^ ^2 as @e[type=interaction,tag=yj-bet-spot-bet,tag=yj-bet-spot-in-play,limit=1,sort=nearest,distance=..1] if score @s yj-stage matches 0 positioned ^ ^0.01 ^-0.5 run return run function yjcasino:war/deal_card
