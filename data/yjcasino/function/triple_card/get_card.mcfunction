...
execute positioned ^4 ^1.01 ^1 as @e[type=interaction,tag=yj-bet-spot-bet,tag=yj-bet-spot-in-play,limit=1,sort=nearest,distance=..1] store result score @s yj-casino-temp run function yjcasino:triple_card/check_duplicate
