...
scoreboard players operation @s yj-money /= $hundred yj-casino-var

execute if score @s yj-money matches 0 run return run tellraw @s "You can't withdraw with less than $100 in your account!"
