...
execute as @e[type=interaction,tag=yj-bet-spot-in-play,tag=yj-bet-spot,tag=!yj-bet-spot-bet,distance=..10] if score @s yj-player-id = $yj-temp yj-id run return run tellraw @s "Bet registered too late. Please wait for this game to finish first."
